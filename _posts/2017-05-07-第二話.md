...
Y : そうですね。ここでもう一つ僕的によくわかんない仮定が入ります。$$\frac{c_1 + c_2 - 2 \sqrt{c_1 c_2}}{\|m_1 - m_2 \|_2^2}が定数になるという仮定です。masoさんこれって大丈夫なんですか？
...
$$
  \begin{align}
    \mathcal{L}_D &= {\cal L}(x;\theta_D) - {\cal L}(G(z_D;\theta_G);\theta_D)\\
    \mathcal{L}_G &= {\cal L}(G(z_G;\theta_G);\theta_D)\\
  \end{align}\
$$
