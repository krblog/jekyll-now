...
So I totally agree, inverting these relations can be a problem. But this algorithmically, it seems like no one cares. We are updating z and w in turn. 

G: Why did they swap this order? Everyone writes min max, instead of max min.  In GAN, we do 
